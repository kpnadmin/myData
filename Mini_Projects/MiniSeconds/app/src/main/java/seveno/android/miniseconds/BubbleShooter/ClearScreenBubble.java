...
import seveno.android.miniseconds.duckcard.CardStartActivity;

public class ClearScreenBubble extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_clear_bubble_screen);
   ...
   private void setupFinalTimeTextView(long initialTime, long elapsedTime){
    ...
    public void btn_bubble_next(View view){
        Intent intent = new Intent(this, CardStartActivity.class);
      /*  intent.putExtra("seveno.android.miniseconds.BubbleShooter.BubbleGame.initialTime",initialTime);
        ...
        intent.putExtra("seveno.android.miniseconds.duckcard.cardstart.initialTime",initialTime);
        intent.putExtra("seveno.android.miniseconds.duckcard.cardstart.elapsedTime",final_elapsedTime);
        intent.putExtra("seveno.android.miniseconds.duckcard.cardstart.tscore",T_score);

package game.speed.android.truthordare.Screen;
...
import game.speed.android.truthordare.MainActivity;
import game.speed.android.truthordare.R;
...
public class DoorOpenActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable(){
            @Override
            public void run(){
                Intent intent = new Intent (DoorOpenActivity.this,MainActivity.class);
